...
<div class="pagetitle">
    <h1>Tambah Data Transaksi Pembelian</h1>
    <nav>
      <ol class="breadcrumb">
        <li class="breadcrumb-item">Transaksi Pembelian</li>
        <li class="breadcrumb-item"><a href="{{ route('transaksipembelian') }}"></a>Data Transaksi Pembelian</li>
        <li class="breadcrumb-item active">Tambah Data Transaksi Pembelian</li>
      </ol>
    </nav>
</div><!-- End Page Title -->
...
<div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-body"><br>
        <form class="row g-3" action="{{ route('inserttransaksipembelian') }}" method="POST">
        @csrf
        <div class="col-12">
